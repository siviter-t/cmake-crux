...
macro(addSubTreeDependency X)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${X}")
    ...
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${X}/inc")
      include_directories("${CMAKE_CURRENT_SOURCE_DIR}/${X}/inc")
    elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${X}/include")
      include_directories("${CMAKE_CURRENT_SOURCE_DIR}/${X}/include")
    endif()
    message(STATUS "Found subtree dependency: ${X}")
  elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/branch/${X}")
    include_directories("${CMAKE_CURRENT_SOURCE_DIR}/branch/${X}")
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/branch/${X}/inc")
      include_directories("${CMAKE_CURRENT_SOURCE_DIR}/branch/${X}/inc")
    elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/branch/${X}/include")
      include_directories("${CMAKE_CURRENT_SOURCE_DIR}/branch/${X}/include")
    endif()
    message(STATUS "Found subtree dependency: ${X}")
  else()
